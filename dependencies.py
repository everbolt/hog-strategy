...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if score + picky_score == opponent_score or picky_score >= cutoff:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
